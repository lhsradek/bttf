...
interface LoggingEventRepository: JpaRepository<LoggingEvent, Long> {
	 ...
	 */
	@Query(value = "select new local.intranet.bttf.api.info.LevelCount(u.levelString, count(u.levelString)) " +
    ...
    fun findPageByLevelString(pageable: Pageable, levelString: Pageable): Page<LoggingEvent>
	...
	fun findPageByCaller(pageable: Pageable, callerClass: List<String>, callerMethod: List<String>,
                         levelString: List<String>): Page<LoggingEvent> 
